...
/**
 * Proxy handler (Next.js 16 replacement for middleware) — four layers:
 *
 * 1. **Rate limiting** — tiered limits on API/auth endpoints.
 * 2. **Auth gating** — /account/* requires an active Supabase session.
 * 3. **Request ID** — X-Request-Id for log correlation.
 * 4. **Security headers** — CSP, HSTS, X-Frame-Options, etc. on every response.
 */
