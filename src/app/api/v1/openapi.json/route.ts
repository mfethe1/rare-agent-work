...
const spec = {
  ...
  info: {
    ...
    version: '1.0.0',
    description: 'Public read-only API for AI agents to access curated news, report catalog data, and natural-language discovery from Rare Agent Work. Includes trust and discovery metadata for agent consumers.',
    ...
    'x-trust-controls': 'https://rareagent.work/trust',
  },
